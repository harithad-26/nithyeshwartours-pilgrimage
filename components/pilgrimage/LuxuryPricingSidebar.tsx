...
export default function LuxuryPricingSidebar({ pkg }: LuxuryPricingSidebarProps) {
  return (
    <aside className="w-full" aria-label="Package booking and quick facts">
      ...
      <div className="bg-[#000613] text-white border border-white/10 hover:border-gold-dark/30 transition-all duration-300 p-6 shadow-card relative overflow-hidden">
        {/* Subtle Decorative Gradient */}
        <div className="absolute -right-24 -top-24 w-48 h-48 bg-gold-dark/10 rounded-full blur-3xl pointer-events-none" />
        
        <span className="font-sans text-[10px] font-bold tracking-[0.25em] text-gold uppercase mb-2 block">
          {pkg.code}
        </span>
        <h3 className="font-serif text-xl text-white font-light leading-snug mb-4">
          {pkg.name}
        </h3>
        ...
        <div className="mb-5 pb-5 border-b border-white/10">
          ...
          <p className="font-sans text-[11px] text-white/60 mt-1 italic">
            {pkg.pricing.notes}
          </p>
        </div>
        ...
        <div className="space-y-3">
          <Link
            ...
            className="flex items-center justify-center font-sans text-sm font-semibold bg-white text-[#000613] w-full py-3 transition-all duration-300 hover:bg-gold hover:text-[#000613] min-h-[44px] tracking-wider uppercase"
          >
            Submit Inquiry
          </Link>
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 font-sans text-sm font-medium text-white border border-white/20 w-full py-3 transition-all duration-300 hover:bg-white/10 min-h-[44px] tracking-wider"
          >
        ...
        <div className="mt-5 pt-5 border-t border-white/10">
          <h4 className="font-serif text-base text-gold font-light mb-1.5">Sacred Devotion, Professional Safety</h4>
