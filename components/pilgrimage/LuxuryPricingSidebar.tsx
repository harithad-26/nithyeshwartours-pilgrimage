      ...
      <div className="bg-[#000613] text-white border border-white/10 hover:border-gold-dark/30 transition-all duration-300 p-5 shadow-card relative overflow-hidden">
        ...
        <div className="space-y-2.5">
          <Link
            ...
            className="flex items-center justify-center font-sans text-xs font-semibold bg-white text-[#000613] w-full py-2.5 transition-all duration-300 hover:bg-gold hover:text-[#000613] min-h-[40px] tracking-wider uppercase"
          >
            Submit Inquiry
          </Link>
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 font-sans text-xs font-medium text-white border border-white/20 w-full py-2.5 transition-all duration-300 hover:bg-white/10 min-h-[40px] tracking-wider"
          >
